...
const AttendanceSummary = () => {
  const [openAttendanceView, setOpenAttendanceView] = useState(false);
  ...
  return (
    <div className="bg-white my-[40px] p-[20px]">
              ...
              <td className="h-10 py-2 flex justify-center">
                <div className="flex items-center justify-center mt-[15px]">
                  <div className="flex items-center gap-[10px]">
                    ...
                    <button
                      onClick={() => setOpenAttendanceView(!openAttendanceView)}
                    >
                      <LuView />
                    </button>
                  </div>
      ...
      {/* ======> Attendance View box <===== */}
      {openAttendanceView && <AttendanceView setOpen={setOpenAttendanceView} />}
    </div>
  );
};
